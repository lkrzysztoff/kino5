import { Component, Input, NO_ERRORS_SCHEMA, OnInit, Output, EventEmitter, ViewChild, ElementRef } from '@angular/core';
...
export class OrderComponent implements OnInit {
  ...
  constructor(public filmRepository: FilmRepository, public cart : Cart, public orderService : OrderManagmentService, public router : Router) {
  }
